...
/////// USEEFECTS======================================================
  useEffect(() => {
    if (selectedDate && !appointmentsLoaded) {
      loadAppointments(formatDate(selectedDate));
      generateTimeSlots();
      setAppointmentsLoaded(true);
    }
  }, [selectedDate, appointmentsLoaded, loadAppointments, generateTimeSlots]);
  ...
  const handleNameClick = (name, time) => {
    ...
    console.log('hora despues de setselectedtime: ', selectedTime);
  };
